...
const MyProfile = () => {
  const [userData , setUserData]=useState({
    name:"Fahad akhtar saifi",
    Image:assets.profile_pic,
    email:'fahadakhter809@gmail.com',
    phone:"+91981893731",
    address:{
      line1:"house no 478 ",
      line2:"toli mohalla loni ghaziabad"
    },
    gender:'Male',
    dov:"10/11/2003"
  })
...
{
  isEdit
  ? <input className='bg-gray-50 text-3xl font-medium-800 mt-4' type="text"value={userData.name} onChange={e=>setUserData(prev =>({...prev,name:e.target.value}))}/>
  : <p className='font-medium text-3xl text-neutral-800 mt-4'>{userData.name}</p>
}
<hr className='bg-zinc-400 h-[1PX] border-none' />
<div>
  <p className='text-neutral-500 underline mt-3'>CONTACT INFRMATION</p>
