...
for(let i=0; i<7 ;i++){
  ...
  //setting and time of the date with iindex
  ...
  return docInfo && (
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4'>
        ...
        <div className='flex-1 border border-fgray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          {/* dr info name degrre and expresianvce */}
         ...
         <p className='text-gray-500 font-medium mt-4'>
          Appoinitment fee: <span className='text-gray-600'>{currencySymbol}{docInfo.fees}</span>
         </p>
        </div>
      </div>
      {/* BOOKING SLOTS */}
...
<button className='bg-blue-500 rounded-full text-white text-sm font-light px-14 py-3  my-6'>Book and Appointment</button>
      </div>
{/* listed realeted dr */}
